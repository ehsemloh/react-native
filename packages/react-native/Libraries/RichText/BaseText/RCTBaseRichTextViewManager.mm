...
#import <React/RCTBaseRichTextViewManager.h>

@implementation RCTBaseRichTextViewManager

RCT_EXPORT_MODULE(RCTBaseRichText)

- (UIView *)view
{
  RCTAssert(NO, @"The `-[RCTBaseRichTextViewManager view]` property must be overridden in subclass.");
  return nil;
}

- (RCTShadowView *)shadowView
{
  RCTAssert(NO, @"The `-[RCTBaseRichTextViewManager shadowView]` property must be overridden in subclass.");
  return nil;
}
