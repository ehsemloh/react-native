...
#import <React/RCTRichTextAttributes.h>

#import <React/RCTAssert.h>
#import <React/RCTFont.h>
#import <React/RCTLog.h>

NSString *const RCTRichTextAttributesIsHighlightedAttributeName = @"RCTRichTextAttributesIsHighlightedAttributeName";
NSString *const RCTRichTextAttributesTagAttributeName = @"RCTRichTextAttributesTagAttributeName";

@implementation RCTRichTextAttributes
...
- (instancetype)init
{
  if (self = [super init]) {
    ...
    _opacity = NAN;
      _textTransform = RCTRichTextTransformUndefined;
  }

  return self;
}

- (void)applyTextAttributes:(RCTRichTextAttributes *)textAttributes
{
  ...
  _layoutDirection = textAttributes->_layoutDirection != UIUserInterfaceLayoutDirectionLeftToRight
      ...
      : _layoutDirection;
  _textTransform =
    textAttributes->_textTransform != RCTRichTextTransformUndefined ? textAttributes->_textTransform : _textTransform;
}
...
- (NSDictionary<NSAttributedStringKey, id> *)effectiveTextAttributes
{
  ...
  // Special
  if (_isHighlighted) {
    attributes[RCTRichTextAttributesIsHighlightedAttributeName] = @YES;
  }

  if (_tag) {
    attributes[RCTRichTextAttributesTagAttributeName] = _tag;
  }
...
- (NSString *)applyTextAttributesToText:(NSString *)text
{
  switch (_textTransform) {
    case RCTRichTextTransformUndefined:
    case RCTRichTextTransformNone:
      return text;
    case RCTRichTextTransformLowercase:
      return [text lowercaseString];
    case RCTRichTextTransformUppercase:
      return [text uppercaseString];
    case RCTRichTextTransformCapitalize:
      return capitalizeText(text);
  }
}

- (RCTRichTextAttributes *)copyWithZone:(NSZone *)zone
{
  RCTRichTextAttributes *textAttributes = [RCTRichTextAttributes new];
...
- (BOOL)isEqual:(RCTRichTextAttributes *)textAttributes
{
  if (!textAttributes) {
    return NO;
  }
