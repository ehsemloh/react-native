...
#import "RCTRichTextTransform.h"

NS_ASSUME_NONNULL_BEGIN

extern NSString *const RCTRichTextAttributesIsHighlightedAttributeName;
extern NSString *const RCTRichTextAttributesTagAttributeName;
 ...
 * and <TextInput>.
 */
@interface RCTRichTextAttributes : NSObject <NSCopying>
...
@property (nonatomic, assign) RCTRichTextTransform textTransform;
