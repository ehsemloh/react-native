...
#import <React/RCTRichTextViewManager.h>
...
@interface RCTRichTextViewManager () <RCTUIManagerObserver>

@end

@implementation RCTRichTextViewManager {
  NSHashTable<RCTRichTextShadowView *> *_shadowViews;
}

RCT_EXPORT_MODULE(RCTRichText)
...
- (UIView *)view
{
  return [RCTRichTextView new];
}

- (RCTRichTextShadowView *)shadowView
{
  RCTRichTextShadowView *shadowView = [[RCTRichTextShadowView alloc] initWithBridge:self.bridge];
...
{
  for (RCTRichTextShadowView *shadowView in _shadowViews) {
...
- (void)handleDidUpdateMultiplierNotification
{
  ...
  NSHashTable<RCTRichTextShadowView *> *shadowViews = _shadowViews;
  RCTExecuteOnUIManagerQueue(^{
    for (RCTRichTextShadowView *shadowView in shadowViews) {
