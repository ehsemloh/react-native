...
@interface RCTRichTextView () <UIEditMenuInteractionDelegate>
...
- (void)drawRect:(CGRect)rect
{
  ...
  [_textStorage
      enumerateAttribute:RCTRichTextAttributesIsHighlightedAttributeName
...
- (NSNumber *)reactTagAtPoint:(CGPoint)point
{
  ...
  if (_textStorage.length > 0 && (fraction > 0 || characterIndex > 0) &&
    ...
    reactTag = [_textStorage attribute:RCTRichTextAttributesTagAttributeName atIndex:characterIndex effectiveRange:NULL];
  }
