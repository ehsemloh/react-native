...
#import <React/RCTRichTextShadowView.h>
...
#import <React/RCTRichTextView.h>

@implementation RCTRichTextShadowView {
...
- (void)uiManagerWillPerformMounting
{
  ...
  [textStorage enumerateAttribute:RCTBaseRichTextShadowViewEmbeddedShadowViewAttributeName
  ...
  [_bridge.uiManager addUIBlock:^(RCTUIManager *uiManager, NSDictionary<NSNumber *, UIView *> *viewRegistry) {
    RCTRichTextView *textView = (RCTRichTextView *)viewRegistry[tag];
    if (!textView) {
      return;
    }
    ...
    [textStorage removeAttribute:RCTBaseRichTextShadowViewEmbeddedShadowViewAttributeName
...
- (NSAttributedString *)attributedTextWithMeasuredAttachmentsThatFitSize:(CGSize)size
{
  ...
  [attributedText enumerateAttribute:RCTBaseRichTextShadowViewEmbeddedShadowViewAttributeName
                             inRange:NSMakeRange(0, attributedText.length)
                             options:0
                          usingBlock:^(RCTShadowView *shadowView, NSRange range, __unused BOOL *stop) {
                            if (!shadowView) {
...
- (void)layoutSubviewsWithContext:(RCTLayoutContext)layoutContext
{
  ...
  [textStorage
      enumerateAttribute:RCTBaseRichTextShadowViewEmbeddedShadowViewAttributeName
    ...
    YGMeasureMode heightMode)
{
  ...
  RCTRichTextShadowView *shadowTextView = (__bridge RCTRichTextShadowView *)YGNodeGetContext(node);
