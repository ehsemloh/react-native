  ...
  if (
    ...
    if (element._owner) {
      ...
      if (element) {
        if (1 !== element.tag)
          throw Error(
            "Function components cannot have string refs. We recommend using useRef() instead. Learn more about using refs safely here: https://react.dev/reference/react/Component#refs"
          );
...
function pushHostContext(fiber) {
  ...
  JSCompiler_inline_result =
    ...
    "RCTRichText" === JSCompiler_inline_result ||
    "RCTVirtualText" === JSCompiler_inline_result ||
    "RCTRichVirtualText" === JSCompiler_inline_result;
  JSCompiler_inline_result =
